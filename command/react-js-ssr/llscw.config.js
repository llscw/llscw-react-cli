...
module.exports.ssr = ({ userFolder, srcFolder, buildFolder, gitVersion, currentEnv, webpack, webpackDevServer }) => {
  return {
    webpackConfig: {
      // output: {
      //   path: path.resolve(__dirname, "build"),
...
module.exports.csr = ({ userFolder, srcFolder, buildFolder, gitVersion, currentEnv, webpack, webpackDevServer }) => {
  return {
    webpackConfig: {
      // output: {
      //   path: path.resolve(__dirname, "build"),
